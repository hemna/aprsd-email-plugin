#!/usr/bin/env python3
"""
CLI tool for aprsd-email-plugin configuration export.
"""
...
def export_config_cmd(format="json"):
    ...
    try:
        from aprsd_email_plugin.conf.opts import export_config
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Export aprsd-email-plugin configuration options"
    )
    parser.add_argument(
        "--format",
        choices=["dict", "json"],
